...
public class SellStock implements TradingStrategy {
	...
	public void execute(String inputCommand) {
		...
		while (!buyOrderBookMaxHeap.isEmpty() && buyOrderBookMaxHeap.peek().getPrice() >= sellOrderPrice
			...
			log.info(Constants.TRADE + Constants.SPACE + currentSale + Constants.AT + buyOrder.getPrice());
